...
DEFAULT_PRODUCTS = [
    ...
    ("310 диамонд", 310, 31, 29.50),
    ("520 диамонд", 520, 52, 49.50),
    ("1060 диамонд", 1060, 106, 100.00),
    ("2180 диамонд", 2180, 218, 200.00),
    ("5600 диамонд", 5600, 560, 500.00),
    ("Ваучери лайт", 200, 0, 6.50),
    ("Ваучери ҳафтагӣ", 450, 0, 17.50),
    ("Ваучери моҳона", 2600, 0, 105.00),
]
