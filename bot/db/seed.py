...
DEFAULT_PRODUCTS = [
    ...
    ("520 DIAMOND", 520, 52, 47.50),
    ("1060 DIAMOND", 1060, 106, 89.90),
    ("2180 DIAMOND", 2180, 218, 180.00),
    ("5600 DIAMOND", 5600, 560, 470.00),
    ("Ваучери Lite", 90, 0, 6.00),
    ("Ваучери weeky", 450, 0, 17.50),
    ("Ваучери Monther", 2600, 0, 95.00),
